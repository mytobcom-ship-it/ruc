...
private:
	...
	// 양방향 분리(왕복차로 별도 링크) 짝 링크 페어링 — m_mapOppositeLinkID 채움 (2026-08-19 최정우 추가)
	void ComputeOppositeLinkPairs();
...
private:
	...
	unordered_map<uint64, uint64>	*m_mapOppositeLinkID;		// 반대방향(왕복분리) 짝 링크 ID (2026-08-19 최정우 추가)
