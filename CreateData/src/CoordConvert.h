...
#define EPSG3857_LAT_MIN			-31000000				// EPSG3857 y 최소 값
#define EPSG3857_LAT_MAX			20000000				// EPSG3857 y 최대 값
...
*/
#define KATECH_LON_MIN				90000					// KATECH x 최소 값
#define KATECH_LON_MAX				800000					// KATECH x 최대 값
#define KATECH_LAT_MIN				40000					// KATECH y 최소 값
#define KATECH_LAT_MAX				700000					// KATECH y 최대 값

/**
 * @brief BESSELGEO 좌표계 최대, 최소 값
*/
#define BESSELGEO_LON_MIN			124						// BESSELGEO x 최소 값
#define BESSELGEO_LON_MAX			133						// BESSELGEO x 최대 값
#define BESSELGEO_LAT_MIN			32						// BESSELGEO y 최소 값
#define BESSELGEO_LAT_MAX			39						// BESSELGEO y 최대 값

/**
 * @brief BESSELTM 좌표계 최대, 최소 값
*/
#define BESSELTM_LON_MIN			-90000					// BESSELTM x 최소 값
#define BESSELTM_LON_MAX			800000					// BESSELTM x 최대 값
#define BESSELTM_LAT_MIN			-170000					// BESSELTM y 최소 값
#define BESSELTM_LAT_MAX			700000					// BESSELTM y 최대 값

/**
 * @brief GRS80GEO 좌표계 최대, 최소 값
*/
#define GRS80GEO_LON_MIN			124						// GRS80GEO x 최소 값
#define GRS80GEO_LON_MAX			133						// GRS80GEO x 최대 값
#define GRS80GEO_LAT_MIN			32						// GRS80GEO y 최소 값
#define GRS80GEO_LAT_MAX			39						// GRS80GEO y 최대 값

/**
 * @brief GRS80TM 좌표계 최대, 최소 값
*/
#define GRS80TM_LON_MIN				-90000					// GRS80TM x 최소 값
#define GRS80TM_LON_MAX				800000					// GRS80TM x 최대 값
#define GRS80TM_LAT_MIN				-170000					// GRS80TM y 최소 값
#define GRS80TM_LAT_MAX				700000					// GRS80TM y 최대 값

/**
 * @brief GRS80UTMK 좌표계 최대, 최소 값
*/
#define GRS80UTMK_LON_MIN			690000					// GRS80UTMK x 최소값
#define GRS80UTMK_LON_MAX			1400000					// GRS80UTMK x
#define GRS80UTMK_LAT_MIN			1440000					// GRS80UTMK y 최소값
#define GRS80UTMK_LAT_MAX			2100000					// GRS80UTMK y
