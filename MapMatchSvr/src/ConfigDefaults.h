...
#define CFG_DEF_REVERSE_WEIGHT	3.0								// [mapmatch] reverse_weight — 역행 1m당 비용 가중 (2026-07-20 최정우 추가)
#define CFG_DEF_REVERSE_SPEED	10.0								// [mapmatch] reverse_speed — 저속 데드존 적용 속도 상한 (2026-07-20 최정우 추가)
#define CFG_DEF_REVERSE_MARGIN	2.0									// [mapmatch] reverse_margin — 저속 시 역행 허용거리(m) (2026-07-20 최정우 추가)
