...
--   PK     : (TRIP_ID, GPS_SEQ)
--   INDEX① : PENDING partial (DEVICE_KEY, TRIP_ID, GPS_DT, GPS_SEQ)
--   INDEX② : (DEVICE_KEY, GPS_DT DESC)
...
COMMENT ON COLUMN ROADNET.PRIM_RAWGPS.GPS_DT IS 'INDEX①·②. GPS 측정 시각 KST CHAR(14) YYYYMMDDHH24MISS';
...
COMMENT ON COLUMN ROADNET.PRIM_RAWGPS.RAW_VLD IS 'BOOLEAN. TRUE=맵매칭 대상. PENDING INDEX 조건';
